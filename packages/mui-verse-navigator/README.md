...
<br />
  <a href="https://github.com/unfoldingWord">
    <img src="https://raw.githubusercontent.com/unfoldingWord/oce-editor-tools/main/images/uW.png" alt="Logo" width="300" height="50">
  </a>

# Oce Editor Tools - Base 

#### Bible resources editor tools 
- using Proskomma underneath

<a href="https://oce-editor-tools-base.netlify.app/"><strong>View Demo and examples</strong></a>
...
## Base - is part of the OCE Editor Tools monorepo

This project is organized as a mono-repository. Each package defined in this repo is published to `npm` individually. Find the full documentation here:
